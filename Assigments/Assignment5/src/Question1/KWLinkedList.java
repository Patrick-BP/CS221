package Question1;/*<listing chapter="2" section="8">*/
...
/**
 * Class Question1.KWLinkedList implements a double linked list and
 * a ListIterator.
...
public class KWLinkedList<E> extends AbstractSequentialList<E> {
    ...
    */
     ...
     * @throwsif the list elements do not implement Comparable
     */
